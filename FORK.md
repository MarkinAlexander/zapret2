...
| Дата | Что сделали |
|---|---|
| 2026-09-17 | Диагноз медленного старта/установки на слабых CPU: 92% времени = загрузка TCP_RKN_list.txt (125K хостов, ~790 мс на MT7621) при каждом запуске + ~200 мс UPX. Патч «--dry-run не грузит содержимое hostlists/ipsets» (910→40 мс на боевом конфиге): сначала ветка `perf/skip-lists-in-dry-run`, затем включён в релиз `v1.0.5.2-reasm-fix2` (коммит 12aa7ba). |
